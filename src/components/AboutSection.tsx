import { Box, Code, Heading, Link, Table, Text, VStack } from "@chakra-ui/react";
  ...
  return (
    <VStack align="stretch" gap="6">
      ...
      <Box>
        ...
        <Text mb="2">
          To use the free hosted SRD service, point your domain using
          either:
        </Text>
        ...
        <Text mt="2" fontSize="sm" color="fg.muted">
          You can also{" "}
          <Link
            href="https://github.com/twopow/srd#deploy-your-own"
            target="_blank"
            variant="underline"
          >
            deploy your own
    ...
    <Table.Root size="sm">
      ...
      <Table.Body>
        ...
        <Table.Row>
          ...
          <Table.Cell>
            HTTP status code (301, 302, 307, 308). Default: 302
          </Table.Cell>
        ...
        <Table.Row>
          ...
          <Table.Cell>
            Set to <Code>preserve</Code> to keep the original path and query
            string
          </Table.Cell>
          <Table.Cell>No</Table.Cell>
        </Table.Row>
        <Table.Row>
          ...
          <Table.Cell>
            Referer header policy: <Code>none</Code>, <Code>host</Code>{" "}
            (default), or <Code>full</Code>
          </Table.Cell>
          <Table.Cell>No</Table.Cell>
        </Table.Row>
      </Table.Body>
